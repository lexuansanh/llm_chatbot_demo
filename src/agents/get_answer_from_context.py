...
def get_answer_from_context(state):
    """
    Retrieves an answer from the context using the LLM.
    ...
    """
    logger.info(f"AgentAnswerFromContext ### with state {state['response_message']}")
